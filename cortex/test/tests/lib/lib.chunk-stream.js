...
const should = require('should'),
      ...
      { InputStream, OutputStream } = require('../../../lib/classes/chunk-stream')
...
describe('Lib', function() {
  ...
  describe('Chunk Stream', () => {
    ...
    beforeEach((callback) => {
      ...
      blob = fs.createReadStream(`${__dirname}/../../files/medable.jpg`)
      callback()
    ...
    it('read and output the original result from json objects', (callback) => {
      ...
      blob
        ...
        .on('end', () => {
          should('hashes of input and output should match', inHash === outHash)
          callback()
        })
        .on('error', callback)
