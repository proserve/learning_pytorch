...
/**
 * https://github.com/substack/node-deep-equal/blob/master/LICENSE
 * ... with objectid, regex and strict by default
 */
...
const { toString } = Object.prototype,
      ...
      deepEquals = module.exports = function(actual, expected, opts) {
        ...
        if (actual === expected) {
          ...
          return opts.strict ? actual === expected : actual == expected // eslint-disable-line eqeqeq
