...
var _clone = require('clone');var _clone2 = _interopRequireDefault(_clone);
var _util = require('util.id');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}

var clone_stack = function clone_stack(stack) {
  var new_stack = [(0, _clone2.default)(stack[0])];
  var key = new_stack[0].key,
...
var fieldType = {
  ...
  'date': function date(x) {
    return !!x && (typeof x === 'undefined' ? 'undefined' : _typeof(x)) === 'object' && Object.prototype.toString.call(x) === '[object Date]';
  } };
...
var fieldValidate = {
  ...
  'pattern': function pattern(v, p) {
    ...
    var pattern = void 0,modifiers = void 0;
  ...
  'uniqueItems': function uniqueItems(v) {
    var hash = {};
    for (var i = 0, len = v.length; i < len; i++) {
      var key = JSON.stringify(v[i]);
  ...
  'enum': function _enum(v, p) {
    if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) === 'object') {
      ...
      for (var _i = 0, _len = p.length; _i < _len; _i++) {
        if (v === p[_i]) {return true;}
      }
    }
    return false;
  } };
...
var resolveURI = function resolveURI(env, schema_stack, uri) {
  var curschema = void 0,components = void 0,hash_idx = void 0,name = void 0;
...
var resolveObjectRef = function resolveObjectRef(object_stack, uri) {
  var components = void 0,object = void 0,last_frame = object_stack.length - 1,skip_frames = void 0,frame = void 0,m = /^(\d+)/.exec(uri);
...
var checkValidity = function checkValidity(env, schema_stack, object_stack, options) {
  var i = void 0,len = void 0,count = void 0,hasProp = void 0,hasPattern = void 0;
  var p = void 0,v = void 0,malformed = false,objerrs = {},objerr = void 0,props = void 0,matched = void 0;
  var sl = schema_stack.length - 1,schema = schema_stack[sl],new_stack = void 0;
  var ol = object_stack.length - 1,object = object_stack[ol].object,name = object_stack[ol].key,prop = object[name];
  var errCount = void 0,minErrCount = void 0;
    ...
    if (typeof schema.type === 'string') {
      ...
      if (options.useDefault && schema.default) {
        ...
        schema.type === 'object' && JSON.stringify(prop) === JSON.stringify({})) {
          prop = object[name] = (0, _clone2.default)(schema.default);
        }
      }
...
function Environment() {
  ...
  this.coerceType = {};
  this.fieldType = (0, _clone2.default)(fieldType);
  this.fieldValidate = (0, _clone2.default)(fieldValidate);
  this.fieldFormat = (0, _clone2.default)(fieldFormat);
  this.defaultOptions = (0, _clone2.default)(defaultOptions);
  this.schema = {};
}
...
Environment.prototype = {
  ...
  validate: function validate(name, object, options) {
    var schema_stack = [name],errors = void 0,object_stack = [{ object: { '__root__': object }, key: '__root__' }];
...
var p_env = Symbol('env');
var p_errors = Symbol('errors');

module.exports = function () {

  function Env() {_classCallCheck(this, Env);

    this[p_errors] = null;
    var env = this[p_env] = new Environment();
    ...
    env.addType('objectId', function (id) {
      return (0, _util.couldBeId)(id);
    });
  }_createClass(Env, [{ key: 'validate', value: function validate(

    schema, json) {
      var errors = this[p_errors] = this[p_env].validate(schema, json);
      if (errors) {
