const Expression = require('../expression'),
      ...
      { OperatorFactory, ApiFactory } = require('../factory')

class Expression$operator extends Expression {
  ...
  parse(value) {
    ...
    super.parse(OperatorFactory.require(key.slice(1), value[key], this))
...
module.exports = Expression$operator
